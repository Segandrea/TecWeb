...
function create_each_block(ctx) {
  ...
  let t19;
  let show_if =
    ctx[22].state === "open" && new Date() < new Date(ctx[22].startDate);
  let t20;
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (
        dirty & 16 &&
        a_href_value !== (a_href_value = path(`/orders/${ctx2[22]._id}`))
      ) {
      ...
      if (
        dirty & 16 &&
        t10_value !== (t10_value = formatDate(ctx2[22].startDate) + "")
      )
        set_data(t10, t10_value);
      if (
        dirty & 16 &&
        t14_value !== (t14_value = formatDate(ctx2[22].endDate) + "")
      )
        set_data(t14, t14_value);
      if (
        dirty & 16 &&
        t18_value !== (t18_value = ctx2[22].totalPrice.toFixed(2) + "")
      )
        set_data(t18, t18_value);
      if (dirty & 16)
        show_if =
          ctx2[22].state === "open" &&
          new Date() < new Date(ctx2[22].startDate);
      if (show_if) {
        if (if_block) {
...
function create_fragment(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    if (ctx2[4] && ctx2[4].length > 0) return create_if_block;
  ...
  return {
    ...
    l(nodes) {
      ...
      button0 = claim_element(form0_nodes, "BUTTON", {
        class: true,
        type: true,
      });
      ...
      button2 = claim_element(div5_nodes, "BUTTON", {
        type: true,
        class: true,
      });
    ...
    h() {
      ...
      attr(
        input0,
        "class",
        "form-control border-bottom-0 rounded-0 rounded-top svelte-ou1abz"
      );
      ...
      attr(
        input1,
        "class",
        "form-control border-top-0 rounded-0 rounded-bottom svelte-ou1abz"
      );
      ...
      attr(
        div5,
        "class",
        "d-flex align-items-center justify-content-center svelte-ou1abz"
      );
        ...
        if (default_slot.p && (!current || dirty & 2048)) {
          update_slot_base(
            ...
            !current
              ...
              : get_slot_changes(default_slot_template, ctx2[11], dirty, null),
            null
          );
        }
      }
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("profile" in $$props2) $$invalidate(3, (profile = $$props2.profile));
    if ("orders" in $$props2) $$invalidate(4, (orders = $$props2.orders));
