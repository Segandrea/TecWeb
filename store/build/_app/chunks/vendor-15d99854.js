...
function create_if_block$1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty & 1 && stop1_offset_value !== (stop1_offset_value = "" + (ctx2[0] * 100 + "%"))) {
        attr(stop1, "offset", stop1_offset_value);
      }
      if (dirty & 1 && stop2_offset_value !== (stop2_offset_value = "" + (ctx2[0] * 100 + "%"))) {
        attr(stop2, "offset", stop2_offset_value);
      }
      if (dirty & 2 && linearGradient_id_value !== (linearGradient_id_value = "grad-" + ctx2[1])) {
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      attr(path, "fill", path_fill_value = ctx[0] === 1 ? ctx[3] : ctx[0] === 0 ? ctx[4] : `url(#grad-${ctx[1]})`);
      attr(path, "d", "M187.183 57.47a9.955 9.955 0\n    00-8.587-6.86l-54.167-4.918-21.42-50.134a9.978 9.978 0 00-9.172-6.052 9.972\n    9.972 0 00-9.172 6.061l-21.42 50.125L9.07 50.611a9.973 9.973 0 00-8.578\n    6.858 9.964 9.964 0 002.917 10.596l40.944 35.908-12.073 53.184a9.97 9.97 0\n    003.878 10.298A9.953 9.953 0 0042 169.357a9.937 9.937 0\n    005.114-1.424l46.724-27.925 46.707 27.925a9.936 9.936 0 0010.964-.478 9.979\n    9.979 0 003.88-10.298l-12.074-53.184 40.944-35.9a9.98 9.98 0\n    002.925-10.604zm0 0");
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & 3 && path_fill_value !== (path_fill_value = ctx2[0] === 1 ? ctx2[3] : ctx2[0] === 0 ? ctx2[4] : `url(#grad-${ctx2[1]})`)) {
...
class Star extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { full: 0, id: 1, config: 6 });
  }
}
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      const star_changes = {};
      if (dirty & 1)
        star_changes.id = ctx2[0];
      if (dirty & 32)
        star_changes.full = ctx2[12];
      if (dirty & 8)
        star_changes.config = ctx2[3];
...
class StarRating extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, { id: 0, rating: 1, style: 2, config: 3 });
  }
}
export { onMount as A, assign as B, writable as C, create_slot as D, src_url_equal as E, append_hydration as F, listen as G, update_slot_base as H, get_all_dirty_from_scope as I, get_slot_changes as J, run_all as K, component_subscribe as L, binding_callbacks as M, derived as N, noop as O, query_selector_all as P, destroy_each as Q, onDestroy as R, SvelteComponent as S, set_style as T, StarRating as U, toggle_class as V, set_input_value as W, prevent_default as X, to_number as Y, getContext as Z, children as a, attr as b, claim_element as c, detach as d, element as e, insert_hydration as f, claim_text as g, set_data as h, init as i, create_component as j, space as k, empty as l, claim_component as m, claim_space as n, mount_component as o, get_spread_update as p, get_spread_object as q, group_outros as r, safe_not_equal as s, text as t, transition_out as u, destroy_component as v, check_outros as w, transition_in as x, setContext as y, afterUpdate as z };
